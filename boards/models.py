...
class Post(models.Model):
    ...
    # the + in related name shows that we dont want a reverse relationship. i.e. post will have which user updated it
    # but under the user there wont be any field which shows how many posts has s/he updated
